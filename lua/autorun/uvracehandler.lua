...
if SERVER then
    ...
    hook.Add( "HUDPaint", "UVHUDRace", function() --HUD
        ...
        local lang = language.GetPhrase
		if hudyes then
            UV_UI [ hudtype ].main( my_vehicle, my_array, string_array )
            ...
            --         if is_local_player then
            --             color = LBColors.MW_LocalPlayer
            --         elseif entry[3] == 'Disqualified' or entry[3] == 'Busted' then
            --             color = LBColors.MW_Disqualified
            --         else
            --             color = LBColors.MW_Others
            --         end
